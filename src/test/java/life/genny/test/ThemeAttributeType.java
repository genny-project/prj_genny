...
public enum ThemeAttributeType {
	...
	PRI_HPRI_HAS_QUESTION_GRP_DESCRIPTION("PRI_HAS_QUESTION_GRP_DESCRIPTION"),AS_REQUIRED("PRI_HAS_REQUIRED"), PRI_HAS_HINT("PRI_HAS_HINT"), PRI_HAS_DESCRIPTION("PRI_HAS_DESCRIPTION"),
