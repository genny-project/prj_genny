...
public void testTableHeader() {
        ...
        String searchBarString = "univ";
  		  ...
  		  SearchEntity searchBE = new SearchEntity("SBE_SEARCH","Search")
  		  	     ...
  		  	     QDataBaseEntityMessage  msg = tableUtils.fetchSearchResults(searchBE,userToken);
  		  	     
  		  	     
  		  	     TableData tableData = tableUtils.generateTableAsks(searchBE,userToken,  msg);
  		         ...
  		         Ask headerAsk = tableData.getAsk();
  		      	 ...
  		      	 String json = JsonUtils.toJson(headerAskMsg);
  		      	...
  		      	QDataBaseEntityMessage  headermsg = TableUtilsTest.changeQuestion("FRM_TABLE_HEADER",headerAskCode,serviceToken,userToken,askMsgs);
  			    for (QDataAskMessage askMsg : askMsgs) {
  		      	 ...
  		      	 VertxUtils.writeMsg("webcmds", JsonUtils.toJson(headermsg));
  		      	 
  		      	 
  		      	 /* Now to display the rows */
  		      	 List<BaseEntity> rowList = Arrays.asList(msg.getItems());
  		      	 List<Ask> rowAsks = generateQuestions(userToken, beUtils, rowList,columns,userToken.getUserCode());
 ...
 */
public List<Ask> generateQuestions(GennyToken userToken,BaseEntityUtils beUtils, List<BaseEntity> bes , Map<String, String> columns, String targetCode) {
