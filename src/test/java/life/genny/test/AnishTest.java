...
public class AnishTest extends GennyJbpmBaseTest {
        ...
        public Frame3 generateCards(String count) {
                ...
                Theme THM_CARD = Theme.builder("THM_CARD").addAttribute(ThemeAttributeType.PRI_IS_INHERITABLE, false)
                                ...
                                .shadowRadius(5).shadowOffset().width(0).height(0).end().end().build();
        ...
        public Frame3 generateHeader(){
                ...
                try {
                        ...
                        Frame3 FRM_DUMMY = VertxUtils.getObject(serviceToken.getRealm(), "", "FRM_DUMMY", Frame3.class,serviceToken.getToken());
        ...
        public Frame3 generateFooter(){
                ...
                try {
                	...
                	Frame3 FRM_POWERED_BY = Frame3.builder("FRM_POWERED_BY")
                			...
                			.addTheme("THM_FORM_DEFAULT_REPLICA", serviceToken).weight(3.0).end()
                			.end()
                			.build();
        ...
        public Frame3 generateBucket() {
                ...
                Frame3 bucketColumn4 = Frame3.builder("FRM_BUCKET_COLUMN_FOUR").addTheme(THM_BUCKET_COLUMN).end()
                                ...
                                .addFrame(frameCard19, FramePosition.NORTH).end().build();
        ...
        public Frame3 generateTabs() {
                ...
                Frame3 tab2 = Frame3.builder("FRM_TAB_TWO").addTheme(THM_TAB).end().question("QUE_TAB_TABLE_VIEW").end()
                                .build();
                Frame3 tab3 = Frame3.builder("FRM_TAB_THREE").addTheme(THM_TAB).end().question("QUE_TAB_DETAIL_VIEW").end()
                                .build();
        ...
        public Frame3 generateDetailView() {
                ...
                Frame3 container = Frame3.builder("FRM_CONTAINER").addTheme(THM_CONTAINER).end()
                ...
                Frame3 FRM_DETAIL_VIEW =Frame3.builder("FRM_DETAIL_VIEW")
                        ...
                        .addFrame(container, FramePosition.NORTH).end().build();
        ...
        public Frame3 generateTableView() {
                ...
                Theme THM_TABLE_VIEW = Theme.builder("THM_TABLE_VIEW")
                        .addAttribute()
                                .backgroundColor("#E2E1E0")
                                .flexDirection("column")
                        .end().build();

                Frame3 FRM_TABLE_VIEW = Frame3.builder("FRM_TABLE_VIEW")
                        .addTheme(THM_TABLE_VIEW).end()
                        .question("QUE_TAB_TABLE_VIEW").end()
                        .build();
