...
public class AnishTest extends GennyJbpmBaseTest {
    ...
    public void testTree() {
        ...
        Theme THM_LOGO = Theme.builder("THM_LOGO").addAttribute().fit("contain").end().addAttribute().height(100).end()
                .addAttribute().width(100).end().build();

        Theme THM_SIDEBAR = Theme.builder("THM_SIDEBAR").addAttribute().backgroundColor("#065B9A").end().addAttribute()
                .minWidth(300).end().addAttribute().width(100).end().build();

        Theme THM_HEADER = Theme.builder("THM_HEADER").addAttribute().backgroundColor("#18639F").end().addAttribute()
                .height(80).end().build();

        Theme THM_FOOTER = Theme.builder("THM_FOOTER").addAttribute().backgroundColor("#16649E").end().addAttribute()
                .bold(true).size("md").end().addAttribute().height(50).end().build();
        ...
        Theme THM_FORM_DEFAULT_REPLICA = Theme.builder("THM_FORM_DEFAULT_REPLICA").addAttribute()
                .backgroundColor("none").end().addAttribute(ThemeAttributeType.PRI_HAS_LABEL, true).end().build();
        ...
        Frame3 logo = Frame3.builder("FRM_PROJECT_LOGO").addTheme(THM_SIDEBAR).end().question("QUE_LOGO")
                .addTheme(THM_LOGO).vcl(VisualControlType.VCL_WRAPPER).end().end().addFrame(frameDummy).end().build();
        ...
        Frame3 project = Frame3.builder("FRM_PROJECT").addThemeParent("THM_PROJECT", "size", "md").end()
                ...
                .addTheme(THM_FORM_LABEL_DEFAULT).vcl(VisualControlType.VCL_LABEL).end().end().addFrame(frameDummy)
                .end().build();
    ...
    public Frame3 generateBucket() {
        ...
        Theme THM_BUCKET_LABEL = Theme.builder("THM_BUCKET_LABEL").addAttribute().textAlign("center").end()
                .addAttribute().margin(0).end().build();

        Theme THM_BUCKET = Theme.builder("THM_BUCKET").addAttribute().backgroundColor("#F8F9FA").end().addAttribute()
                .overflowX("auto").end().addAttribute().overflowY("auto").end().addAttribute().width("100%").end()
                .build();
        ...
        Theme THM_BUCKET_COLUMN_HEADER = Theme.builder("THM_BUCKET_COLUMN_HEADER").addAttribute()
                .backgroundColor("#d1d1d1").end().addAttribute().height(20).end().build();

        Theme THM_BUCKET_COLUMN = Theme.builder("THM_BUCKET_COLUMN").addAttribute().backgroundColor("#EAEAEA").end()
                .addAttribute().minWidth(300).end().addAttribute().width("100%").end().addAttribute().margin(20).end()
                .addAttribute().textAlign("center").end().build();

        Frame3 columnHeader = Frame3.builder("FRM_BUCKET_COLUMN_HEADER").addTheme(THM_BUCKET_COLUMN_HEADER).end()
                .question("QUE_NAME_TWO").addTheme(THM_BUCKET_LABEL).vcl(VisualControlType.VCL_LABEL).end().end()
                .build();
        ...
        Frame3 bucketColumn1 = Frame3.builder("FRM_BUCKET_COLUMN_ONE").addTheme(THM_BUCKET_COLUMN).end()
                ...
                // .end()
                // .end()
                .addTheme(THM_NOT_INHERITBALE).end().addFrame(columnHeader, FramePosition.NORTH).end().build();
        ...
        Frame3 bucket = Frame3.builder("FRM_BUCKET").addTheme(THM_BUCKET).end()
                .addFrame(bucketColumn1, FramePosition.WEST).end().addFrame(bucketColumn2, FramePosition.WEST).end()
                .addFrame(bucketColumn3, FramePosition.WEST).end().addFrame(bucketColumn4, FramePosition.WEST).end()
                .addFrame(bucketColumn5, FramePosition.WEST).end().addFrame(bucketColumn6, FramePosition.WEST).end()
    ...
    public Frame3 generateTabs() {
        ...
        Theme THM_TAB_HEADER = Theme.builder("THM_TAB_HEADER")
                ...
                .addAttribute().backgroundColor("#065B9A").end().addAttribute().flexDirection("row").end()
                .addAttribute().marginRight(5).end().build();
        ...
        Frame3 tab1 = Frame3.builder("FRM_TAB_ONE").addTheme(THM_TAB).end().question("QUE_NAME_TWO").end().build();
        Frame3 tab2 = Frame3.builder("FRM_TAB_TWO").addTheme(THM_TAB).end().question("QUE_NAME_TWO").end().build();
        Frame3 tab3 = Frame3.builder("FRM_TAB_THREE").addTheme(THM_TAB).end().question("QUE_NAME_TWO").end().build();
        ...
        Frame3 tabContent = Frame3.builder("FRM_TAB_CONTENT").addTheme(THM_TAB_CONTENT).end().addFrame(bucket).end()
