 ...
 *
 */
public class LinTestTaskListCreator extends GennyJbpmBaseTest {
	...
	System.out.println("Register Task Test");
	...
	try {
	    gks = GennyKieSession.builder(serviceToken, true)//
		    .addJbpm("taskListCreator.bpmn")//
		    .addToken(userToken)//
		    .build();

	    gks.start();

	    gks.getKieSession().startProcess("taskListCreatorID");
