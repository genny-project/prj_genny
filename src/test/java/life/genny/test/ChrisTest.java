...
//                    .addDrl("CHRIS_RULE.drl")
            ...
            gks.injectSignal("newApplication", hashBeg); // -> Applied
...
//            gks.injectSignal("dropDown", "VIEW_INTERNSHIP_OFFER");
            ...
            gks.injectSignal("controlSignal", "FORWARD"); // -> shortlist
            
            gks.advanceSeconds(5, false);
            
            gks.injectSignal("controlSignal", "FORWARD"); // -> interview
            
            gks.advanceSeconds(5, false);
            
            gks.injectSignal("controlSignal", "FORWARD"); // -> offerred
            
            gks.advanceSeconds(5, false);
            
            gks.injectSignal("controlSignal", "FORWARD"); // -> placed
            
            gks.advanceSeconds(5, false);
            
            gks.injectSignal("controlSignal", "FORWARD"); // -> in progress

            gks.advanceSeconds(15, false);
            
            gks.injectSignal("controlSignal", "FINISH_INTERNSHIP"); // FINISHED
