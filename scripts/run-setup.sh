   ...
   case $1 in
	 ...
	 ;;
      ...
      hazelcast )
         ...
         ./scripts/create_genny_env.sh ${ENV_FILE} $ip >& /dev/null
...
ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-hazelcast.yml up -d
ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-hazelcast.yml logs -f qwanda-service
         ;;
      dev )
         echo "started"
         ...
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-dev.yml up -d
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-dev.yml logs -f qwanda-service
...
ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-staging.yml up -d
ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-staging.yml logs -f  rulesservice
         ;;
      ...
      min | minimal )
         ...
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-min.yml up -d
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-min.yml logs -f bridge  qwanda-service messages
         ;;
      haz )
         echo "started"
         if [ -z "$project" ]; then
         ...
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-hazelcast.yml up -d
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose-hazelcast.yml logs -f bridge rulesservice
         ;;
      up | start )
         echo "started"
         if [ -z "$project" ]; then
         ...
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose.yml  up -d
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/docker-compose.yml logs -f bridge  qwanda-service
         ;;
      local )
         echo "local started"
         if [ -z "$project" ]; then
         ...
         ENV_FILE=$ENV_FILE docker-compose -f docker-compose-files/local.yml up -d
         ;;
      -h | --help )
         #printf "\t
